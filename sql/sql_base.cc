                       ...
                       bool has_prelocking_list)
{
  ...
  bool maybe_need_prelocking=
    (tables->updating && tables->lock_type >= TL_WRITE_MIN)
             ...
             TABLE_LIST *table_list, bool *need_prelocking)
{
  ...
  DBUG_ASSERT(table_list->lock_type >= TL_WRITE_MIN ||
              thd->lex->default_used);
                                      ...
                                      TABLE_LIST *table_list)
{
  ...
  */
  ...
  if ((int) lock_type >= (int) TL_WRITE_MIN &&
      (int) table_list->table->reginfo.lock_type < (int) TL_WRITE_MIN)
  {
  ...
  */
  if (open_and_lock_tables(thd, table_list, FALSE,
                           (MYSQL_OPEN_IGNORE_FLUSH |
                            ...
                            (table_list->lock_type < TL_WRITE_MIN ?
